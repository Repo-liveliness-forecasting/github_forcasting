...
commits.csv$lag2_issues = c(rep(NA, 2), commits.csv$issues[1:(length(commits.csv$issues) - 2)])
...
commits.lr.pred = predict(commits.lr, valid.commits, type = 'response')
...
commits.avnnet.pred = predict(commits.avnnet, valid.commits, type = 'response')
